...
void writefn_data_allocate(struct writefn_data *d, size_t size);
...
inline void writefn_data_allocate(struct writefn_data &d, size_t size)
{
	writefn_data_allocate(&d, size);
}
